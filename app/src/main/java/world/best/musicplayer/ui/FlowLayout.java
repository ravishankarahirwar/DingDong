...
public class FlowLayout extends ViewGroup {
    ...
    private boolean mAddInnerPadding = false;
    ...
    protected void onFinishInflate() {
        ...
        mInnerPadding = getContext()
                .getResources().getDimensionPixelSize(R.dimen.tags_bar_item_inner_margin);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (lineWidth + childWidth > sizeWidth) {
                ...
                if (mAddInnerPadding) {
                    height += lineHeight + mInnerPadding;
                } else {
                    height += lineHeight;
                }
    ...
    public void setAddInnerPadding(boolean addInnerPadding) {
        mAddInnerPadding = addInnerPadding;
    }
