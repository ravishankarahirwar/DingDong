...
public abstract class AbstractDataType
{
    ...
    //Logger
    public static Logger logger = Logger.getLogger("world.best.musicplayer.utils.files.tag.datatype");
     ...
     *
     * @param arr
     * @throws world.best.musicplayer.utils.files.tag.InvalidDataTypeException
     */
