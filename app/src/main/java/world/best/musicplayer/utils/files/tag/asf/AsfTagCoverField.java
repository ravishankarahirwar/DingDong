...
public class AsfTagCoverField extends AbstractAsfTagImageField
{
    ...
    public final static Logger LOGGER = Logger
            .getLogger("world.best.musicplayer.utils.files.audio.asf.tag");
    ...
    private byte[] createRawContent(final byte[] data, final int pictureType,
        ...
        // ImageDataSize
        baos.write(world.best.musicplayer.utils.files.audio.generic.Utils
    ...
    private void processRawContent() throws UnsupportedEncodingException {
        ...
        // ImageDataSize
        this.imageDataSize = world.best.musicplayer.utils.files.audio.generic.Utils.getIntLE(this
                .getRawContent(), 1, 2);
