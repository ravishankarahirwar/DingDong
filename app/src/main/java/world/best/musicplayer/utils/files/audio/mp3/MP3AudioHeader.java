...
import world.best.musicplayer.utils.files.audio.AudioHeader;
...
public class MP3AudioHeader implements AudioHeader
{
    ...
    //Logger
    public static Logger logger = Logger.getLogger("world.best.musicplayer.utils.files.audio.mp3");
     ...
     *
     * This is the first byte of  musicplayer data and not the ID3 Tag Frame.     *
     *
     ...
     * <code>file</code> arguement refers to. This is the first byte of musicplayer
