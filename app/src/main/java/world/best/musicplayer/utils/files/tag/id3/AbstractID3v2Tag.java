...
import world.best.musicplayer.utils.files.audio.exceptions.UnableToCreateFileException;
import world.best.musicplayer.utils.files.audio.exceptions.UnableToModifyFileException;
import world.best.musicplayer.utils.files.audio.exceptions.UnableToRenameFileException;
import world.best.musicplayer.utils.files.audio.generic.Utils;
import world.best.musicplayer.utils.files.audio.mp3.MP3File;
import world.best.musicplayer.utils.files.logging.ErrorMessage;
import world.best.musicplayer.utils.files.logging.FileSystemMessage;
import world.best.musicplayer.utils.files.tag.*;
import world.best.musicplayer.utils.files.tag.datatype.*;
import world.best.musicplayer.utils.files.tag.id3.framebody.*;
...
import world.best.musicplayer.utils.files.tag.reference.PictureTypes;
...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
    ...
    */
     ...
     *
     * @see world.best.musicplayer.utils.files.tag.Tag#hasField(String)
     */
     ...
     * Is this tag empty
     *
     * @see world.best.musicplayer.utils.files.tag.Tag#isEmpty()
     */
