...
import world.best.musicplayer.utils.files.tag.aiff.AiffTag;
import world.best.musicplayer.utils.files.tag.id3.AbstractID3v2Tag;
import world.best.musicplayer.utils.files.tag.id3.ID3v22Tag;
import world.best.musicplayer.utils.files.tag.id3.ID3v23Tag;
import world.best.musicplayer.utils.files.tag.id3.ID3v24Tag;
