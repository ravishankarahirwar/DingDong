 ...
 */
package world.best.musicplayer.utils.files.audio.ogg.util;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("world.best.musicplayer.utils.files.audio.ogg.atom");
