...
import world.best.musicplayer.utils.files.utils.tree.DefaultMutableTreeNode;
import world.best.musicplayer.utils.files.utils.tree.DefaultTreeModel;
import world.best.musicplayer.utils.files.audio.exceptions.CannotReadException;
import world.best.musicplayer.utils.files.audio.exceptions.NullBoxIdException;
import world.best.musicplayer.utils.files.audio.mp4.atom.Mp4BoxHeader;
import world.best.musicplayer.utils.files.audio.mp4.atom.Mp4MetaBox;
import world.best.musicplayer.utils.files.audio.mp4.atom.Mp4StcoBox;
import world.best.musicplayer.utils.files.audio.mp4.atom.NullPadding;
...
public class Mp4AtomTree
{
    ...
    //Logger Object
    public static Logger logger = Logger.getLogger("world.best.musicplayer.utils.files.audio.mp4");
