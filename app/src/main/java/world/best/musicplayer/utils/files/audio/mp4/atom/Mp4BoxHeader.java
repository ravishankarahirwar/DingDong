package world.best.musicplayer.utils.files.audio.mp4.atom;

import world.best.musicplayer.utils.files.audio.exceptions.InvalidBoxHeaderException;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("world.best.musicplayer.utils.files.audio.mp4.atom");
