...
import world.best.musicplayer.utils.files.tag.id3.framebody.FrameBodyDeprecated;
import world.best.musicplayer.utils.files.tag.id3.framebody.FrameBodyUnsupported;
import world.best.musicplayer.utils.files.tag.id3.valuepair.TextEncoding;
import world.best.musicplayer.utils.files.utils.EqualsUtil;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("world.best.musicplayer.utils.files.tag.id3.framebody.FrameBody" + bodyIdentifier);
     ...
     * @throws world.best.musicplayer.utils.files.tag.InvalidFrameException
     */
