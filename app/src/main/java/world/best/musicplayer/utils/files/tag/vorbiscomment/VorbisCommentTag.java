...
import world.best.musicplayer.utils.files.audio.generic.AbstractTag;
...
import static world.best.musicplayer.utils.files.tag.vorbiscomment.VorbisCommentFieldKey.VENDOR;
...
import world.best.musicplayer.utils.files.tag.vorbiscomment.util.Base64Coder;
...
public class VorbisCommentTag extends AbstractTag
{
     ...
     * @throws world.best.musicplayer.utils.files.tag.FieldDataInvalidException
     */
