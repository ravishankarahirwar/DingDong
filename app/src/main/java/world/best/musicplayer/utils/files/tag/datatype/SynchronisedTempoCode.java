...
import world.best.musicplayer.utils.files.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link world.best.musicplayer.utils.files.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link world.best.musicplayer.utils.files.tag.id3.framebody.FrameBodySYTC}
 */
