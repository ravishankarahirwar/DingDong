...
import world.best.musicplayer.utils.files.tag.id3.framebody.AbstractID3v2FrameBody;
import world.best.musicplayer.utils.files.tag.id3.framebody.FrameBodyCOMM;
import world.best.musicplayer.utils.files.tag.id3.framebody.FrameBodyTIPL;
import world.best.musicplayer.utils.files.tag.id3.framebody.ID3v24FrameBody;
import world.best.musicplayer.utils.files.tag.id3.valuepair.TextEncoding;
import world.best.musicplayer.utils.files.tag.lyrics3.Lyrics3v2Fields;
import world.best.musicplayer.utils.files.tag.options.PadNumberOption;
import world.best.musicplayer.utils.files.tag.reference.GenreTypes;
import world.best.musicplayer.utils.files.tag.reference.ID3V2Version;
...
public class TagOptionSingleton
{
     ...
     * data. The start of the MP3 frame data is the start of the musicplayer and is
     ...
     * musicplayer and is different from the ID3v2 frame data. WinAmp 2.8 seems to
     ...
     * the musicplayer and is different from the ID3v2 frame data. WinAmp 2.8 seems
    ...
    {
        return true; // we are under android
    }
